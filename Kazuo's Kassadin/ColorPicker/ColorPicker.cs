...
namespace Kassadin
{
    public sealed class ColorPicker : ValueBase<Color>
    {
        ...
        internal SharpDX.RectangleF MouseClickedBox { get; set; }
        ...
        internal SharpDX.RectangleF RedBar { get; set; }
        internal SharpDX.RectangleF RedBarNative { get { return new SharpDX.RectangleF(Position.X + RedBar.X, Position.Y + RedBar.Y, RedBar.Width, RedBar.Height); } }

        internal SharpDX.RectangleF GreenBar { get; set; }
        internal SharpDX.RectangleF GreenBarNative { get { return new SharpDX.RectangleF(Position.X + GreenBar.X, Position.Y + GreenBar.Y, GreenBar.Width, GreenBar.Height); } }

        internal SharpDX.RectangleF BlueBar { get; set; }
        internal SharpDX.RectangleF BlueBarNative { get { return new SharpDX.RectangleF(Position.X + BlueBar.X, Position.Y + BlueBar.Y, BlueBar.Width, BlueBar.Height); } }

        internal SharpDX.RectangleF AlphaBar { get; set; }
        internal SharpDX.RectangleF AlphaBarNative { get { return new SharpDX.RectangleF(Position.X + AlphaBar.X, Position.Y + AlphaBar.Y, AlphaBar.Width, AlphaBar.Height); } }

        internal SharpDX.RectangleF ColorBar { get; set; }
        internal SharpDX.RectangleF ColorBarNative { get { return new SharpDX.RectangleF(Position.X + ColorBar.X, Position.Y + ColorBar.Y, ColorBar.Width, ColorBar.Height); } }


        public SharpDX.RectangleF ControlBoxNative
        {
            get
            {
                return new SharpDX.RectangleF(Position.X, Position.Y, Width, Height);
            }
        }
        #endregion
        ...
        {
            MouseClickedBox = SharpDX.RectangleF.Empty;
        ...
        {
            if (!IsMouseDown || MouseClickedBox == SharpDX.RectangleF.Empty) return;
        ...
        private bool IsInsideRectangle(SharpDX.RectangleF rectangle, Vector2 checkPos)
        {
        ...
        protected override void OnThemeChange()
        {
            ...
            RedBar = new SharpDX.RectangleF(_barPadding[1], _barPadding[0], BarWidth, DefaultHeight - _barPadding[3]);
            GreenBar = new SharpDX.RectangleF(BarWidth + _barPadding[1] * 2, _barPadding[0], BarWidth, DefaultHeight - _barPadding[3]);
            BlueBar = new SharpDX.RectangleF(BarWidth * 2 + _barPadding[1] * 3, _barPadding[0], BarWidth, DefaultHeight - _barPadding[3]);
            AlphaBar = new SharpDX.RectangleF(BarWidth * 3 + _barPadding[1] * 4, _barPadding[0], BarWidth, DefaultHeight - _barPadding[3]);

            ColorBar = new SharpDX.RectangleF(_barPadding[1], 25, Width - _barPadding[1] - _barPadding[2], 10);
        ...
        private int GetPosValue(SharpDX.RectangleF box, Vector2 position)
        {
        ...
        private Vector2 GetLineStartPos(SharpDX.RectangleF box, int value)
        {
            return new Vector2(box.Left + value * LineWidth, box.Top);
        }
        private SharpDX.RectangleF RectangleFromCenter(Vector2 center, float width, float height)
        {
            return new SharpDX.RectangleF(center.X - width / 2f, center.Y - height / 2f, width, height);
        }
        #endregion
        ...
        private void DrawRectangle(SharpDX.RectangleF rectangle, Color color, float width, bool inflate = true)
        {
        ...
        private void DrawColorPointer(SharpDX.RectangleF box, int color)
        {
        ...
        private void DrawColorBar(SharpDX.RectangleF box, Func<int, Color> colorModifier)
        {
